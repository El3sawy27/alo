...
<style>
    ...
    <table>
        ...
        <tr class="table-main">
            ...
            <td><a class="edti-link" href="{{route('postedit',$post->id)}}">Edit</a></td>
            <td><a class="delete-link" href="{{route('postdelete',$post->id)}}">SoftDelete</a></td>
